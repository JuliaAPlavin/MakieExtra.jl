...
function sel_ints(rs::RectSelection, fplt::FPlot, ::Type{plt}; kwargs...) where {plt <: Plot}
    @lift let
...
function sel_poly(rs::RectSelection, fplt::FPlot, ::Type{plt}; kwargs...) where {plt <: Plot}
...
function sel_span(rs::RectSelection, fplt::FPlot, ::Type{plt}, i::Int; kwargs...) where {plt <: Plot}
    emptyval = NaN..NaN
    ints = sel_ints(rs, fplt, plt; kwargs...)
    @lift let
...
function add!(ax::Axis, rs::RectSelection, fplt::FPlot, ::plt; kwargs...) where {plt <: Plot}
