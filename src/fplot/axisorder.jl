...
argixs_xy_axes(ct::Function, X::FPlot, kwargs) = argixs_xy_axes(Makie.func2type(ct), X, kwargs)
...
argixs_xy_axes(::Type{<:Band}, X::FPlot, kwargs) = get(kwargs, :direction, :x) == :y ? (2, 1) : (1, 2)
