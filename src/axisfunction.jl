for plotf in (
    ...
    @eval $fullname_excl(f::Union{Function,Observable{<:Function},MyObservables.AbstractNode{<:Function}}; kwargs...) = $plotf_excl(current_axis(), f; kwargs...)

    @eval function $fullname_excl(ax::Axis, f::Union{Function,Observable{<:Function},MyObservables.AbstractNode{<:Function}}; kwargs...)
